...
function RequestList({profile}){
   ...
   return(
    <div className="donorHolder">
        <label className='name3'>{profile.donorName}</label>
        <label className='pincode'>{profile.donorPinCode}</label>
        <label className='phoneNumber'>{profile.donorPhoneNumber}</label>
        <label className='bloodgroup'>{profile.donorBloodGroup}</label>

...
function Profile1(){
    ...
    function handelConfirm(){
        ...
        axios
        .patch(`https://bld-donation-api.onrender.com/updateUser/${id}`, registerData)
        .then(() => {
    ...
    return(
        <div>
         ...
         <div className='conProfile'>
            <button onClick={editProfile} disabled={edit} className='buttonEdit'><i class="fa fa-pencil-square" aria-hidden="true"></i></button>
         <div className='name'>
            <div>
                <label>Name</label>
                <br></br>
